...
create table departamento
	(nombre_dpto	varchar(32), 
	 edificio		varchar(34), 
	 presupuesto	numeric(12,2) check (budget > 0),
...
create table horario
	(id_horario		varchar(4),
	 dia			varchar(1),
	 hora_comienzo	numeric(2) check (start_hr >= 0 and start_hr < 24),
	 min_comienzo	numeric(2) check (start_min >= 0 and start_min < 60),
	 hora_fin		numeric(2) check (end_hr >= 0 and end_hr < 24),
	 min_fin		numeric(2) check (end_min >= 0 and end_min < 60),
